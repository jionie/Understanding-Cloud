...
def run_train():
    ...
    initial_checkpoint = \
        '/root/share/project/kaggle/2019/cloud/result/run1/resnet34-fpn256-fold_a0_1/checkpoint/00012500_model.pth'
    ...
    log.write('rate     iter  epoch |  loss           [tn1,2,3,4  :  tp1,2,3,4]                    [dn1,2,3,4  :  dp1,2,3,4]          |  loss    [dn :  dp1,2,3,4]          | time             \n')
    log.write('--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n')
